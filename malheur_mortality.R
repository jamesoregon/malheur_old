...
#All code by James Johnston.  Contact jamesjoh@uoregon.edu with comments or suggestions for improvement.  There's plenty of room for improvement, particularly to the simulation portion of the code.  I may make a run at revising and streamlining it, so drop me a line for updates if you want to use any of this.  
#Note that some of this code may take several minutes or more to run.  The simulations may take a couple hours.  
...
#site_mortality
ggsave(path = "/YOURPATH", filename = "site_mortality.png", width = 2, height = 6.85, units = "in", dpi = 500)
...
ggsave(path="/YOURPATH", "age_structure_plot.png", width = 7.5, height = 7, units = "in", dpi=600)
...
ggsave("/YOURPATH/status_species_plot.png", status_species_plot, width = 7, height = 4, units = "in", dpi = 500)
...
ggsave("/YOURPATH/status_age_plot.png", status_age_plot, width = 7, height = 4, units = "in", dpi = 500)
...
#unburned_vi_plot
#ggsave(path="/YOURPATH/Desktop", "vi_plot.png", width = 6, height = 8, units = "in", dpi=500)
...
ggsave(path="/YOURPATH", "final_rf_model_graphic.png", width = 9.15, height = 7, units = "in", dpi=500)
...
#Save
png("/YOURPATH/partial_dependence_final_ultratight.png", width = 3.72, height = 6.75, units = "in", res = 600)
grid.newpage()
...
#ggsave(path="/YOURPATH", "combine_graphs.png", width = 7, height = 8, units = "in", dpi=500)
